    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_percent', models.DecimalField(blank=True, decimal_places=2, max_digits=3, null=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_rus', models.CharField(blank=True, max_length=200, null=True)),
                ('image', models.ImageField(blank=True, default='/placeholder.png', null=True, upload_to='')),
                ('brand', models.CharField(blank=True, max_length=200, null=True)),
                ('size', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('description_geo', models.TextField(blank=True, null=True)),
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('category', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='base.category')),
                ('color', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='base.color')),
                ('discount', models.ForeignKey(default='0', on_delete=django.db.models.deletion.CASCADE, to='base.discount')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personId', models.CharField(blank=True, max_length=11)),

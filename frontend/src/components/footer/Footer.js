    ...
    <footer className={styles.box}>
      <article className={styles.container}>
        <div className={styles.row}>
          ...
          <section className={styles.column}>
            <div>
              <header className={styles.heading}>{t("footer.social")}</header>
              <a className={styles.element} href="#">
                <svg
          ...
          <section className={styles.column}>
            <div>
              {" "}
              <header className={styles.heading}>{t("footer.contact")}</header>
              ...
              <span className={styles.element}>
                ...
                {t("footer.Tbilisi, Tskalsadeni St. N21")}
              </span>
            </div>
          </section>
          <section className={styles.column}>
            <header className={styles.heading}>{t("footer.location")}</header>
            <div>
              <iframe

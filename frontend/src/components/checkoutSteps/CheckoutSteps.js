...
function CheckoutSteps({ step1, step2, step3, step4 }) {
  ...
  return (
    ...
    {width >1000 && "ავტორიზაცია"}    
      </Link>
      <Link to="/checkout/shippingmethod" className={step1? styles.active : styles.disabled}>
      <svg
      width={512}
      height={512}
      viewBox="0 0 512 512"
    ...
    {width >1000 &&  "მიწოდება"}
      ...
      <Link to="/checkout/shippingdetails" className={(step1 && step2) ? styles.active : styles.disabled}>
        {(step1 && step2) ? 
      <svg
      width={512}
      height={512}
    ...
    {width >1000 &&  "მიწოდების დეტალები"}
      </Link>
      <Link to="/checkout/paymentmethod" className={(step1 && step2 && step3)? styles.active : styles.disabled}>
        {(step1 && step2 && step3) ? 
      <svg
      width={512}
      height={512}
